 ...
 */
package com.android.launcher3.awaken.icon;
...
public class AwakenIconFactory extends BaseIconFactory {
    ...
    public AwakenIconFactory(Context context, int fillResIconDpi, int iconBitmapSize) {
